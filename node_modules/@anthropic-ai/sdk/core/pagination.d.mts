...
export declare class BidirectionalPageCursor<Item> extends AbstractPage<Item> implements BidirectionalPageCursorResponse<Item> {
    data: Array<Item>;
    next_page: string | null;
    prev_page: string | null;
    constructor(client: BaseAnthropic, response: Response, body: BidirectionalPageCursorResponse<Item>, options: FinalRequestOptions);
    getPaginatedItems(): Item[];
    nextPageRequestOptions(): PageRequestOptions | null;
}
